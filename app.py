...
def render_landing_page():
    """Immersive landing page with animated background and interactive features."""
...
.hero-title .line1 { display: block; color: #f1f5f9; }
.hero-title .line2 {
    display: block;
...
/* FEATURES */
.section-title-area { text-align: center; margin-bottom: 48px; }
.section-tag {
    display: inline-block;
    padding: 6px 16px;
    background: rgba(99,102,241,0.1);
...
.feature-card h3 { font-size: 1.15rem; font-weight: 700; color: #f1f5f9; margin-bottom: 10px; }
.feature-card p { font-size: 0.9rem; color: #94a3b8; line-height: 1.65; }
...
.step-item h3 { font-size: 1.1rem; font-weight: 700; color: #f1f5f9; margin-bottom: 10px; }
.step-item p { font-size: 0.88rem; color: #94a3b8; line-height: 1.6; }
...
.stat-num {
    ...
    font-size: 2.8rem;
    font-weight: 700;
    background: linear-gradient(135deg, var(--c1, #6366f1), var(--c2, #818cf8));
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    line-height: 1;
    margin-bottom: 8px;
...
/* Final CTA */
.final-cta { text-align: center; padding: 80px 20px; margin-bottom: 40px; }
.final-cta h2 {
    font-family: 'Space Grotesk', sans-serif;
    font-size: 3rem;
    font-weight: 700;
...
.final-cta p { font-size: 1.1rem; color: #94a3b8; margin-bottom: 36px; }
...
<div class="main-content">
    ...
    <div class="stats-bar reveal">
        <div class="stat-item">
            <div class="stat-num" style="--c1:#6366f1;--c2:#818cf8;">500+</div>
            <div class="stat-label">Active Students</div>
        </div>
        <div class="stat-item">
            <div class="stat-num" style="--c1:#22c55e;--c2:#4ade80;">1,200+</div>
            <div class="stat-label">Mock Interviews</div>
        </div>
        <div class="stat-item">
            <div class="stat-num" style="--c1:#f59e0b;--c2:#fbbf24;">85%</div>
            <div class="stat-label">Placement Rate</div>
        </div>
        <div class="stat-item">
            <div class="stat-num" style="--c1:#a78bfa;--c2:#c4b5fd;">100%</div>
...
// Navigation — uses Streamlit query params
function navigateTo(page) {
    // Get the base URL of the parent (works on both localhost and Streamlit Cloud)
    const baseUrl = window.location.ancestorOrigins
        ? window.location.ancestorOrigins[0]
        : window.location.origin;
    // Navigate parent to the page via query param
    ...
    # Use Streamlit's built-in HTML component (works on Cloud — no iframe security issues)
